...
export class AuthService {
  ...
  requestPasswordResetSuperAdmin(email: string): Observable<{ message: string }> {
    return this.http.post<{ message: string }>(`${environment.apiUrl}/auth/forgot-password/superadmin`, {
      email,
    });
  }
